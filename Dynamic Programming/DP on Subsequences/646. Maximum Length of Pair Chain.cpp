...
// Similar Approach as the problem Longest Increasing Subsequence

// Solved by Greedy Approach (Sorting ending interval)
...
// Solved by Greedy Approach (Sorting starting interval)
// Time Complexity :- O(nlogn)
// Space Complexity :- O(1)
